...
interface Transport {
	...
	/**
	 * Send a request to the server and return a \JExtstore\Component\Gptranslate\Administrator\Framework\Http\Response object with the response.
	 *
	 ...
	 *
	 * @return  \JExtstore\Component\Gptranslate\Administrator\Framework\Http\Response
	 *
	 * @since   11.3
	 */
