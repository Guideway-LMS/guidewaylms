	...
	public function renderFeature()
	{
		...
		if ($offcanvas_position === 'left') {
			if ($menu_type === 'mega') {
				...
				$html .= '<a id="offcanvas-toggler" aria-label="' . Text::_('HELIX_ULTIMATE_NAVIGATION') . '" class="offcanvas-toggler-left d-flex align-items-center" href="#" aria-hidden="true" title="' . Text::_('HELIX_ULTIMATE_NAVIGATION') . '"><div class="burger-icon"><span></span><span></span></div></a>';
			}
		}
