...
// === GUIDEWAY CUSTOM: BUSCA DE SUBMISSION PARA O CERTIFICADO ===
$submission_id = 0;

if (!$user->guest) {
    $db = Factory::getDbo();
    // Procura por algum envio de trabalho do aluno para atrelar ao certificado (se houver)
    ...
    $db->setQuery($queryCert, 0, 1); // Pega o último envio
  ...
  <div class="splms-course">
    ...
    <div class="row">
          ...
          <div class="container">
            <ul>
              ...
              <li>
                ...
                ?>
                <a href="<?php echo $certDownloadUrl; ?>"
                id="certificate-btn"
      ...
      <div class="splms-col-md-4">
        ...
        </div> <div class="splms-course-introduction">
      ...
      <?php } ?>
    </div> <?php if (isset($this->item->course_schedules) && $this->item->course_schedules && count($this->item->course_schedules) && $this->item->course_schedules) { ?>
