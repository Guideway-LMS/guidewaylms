    ...
    <div class="row">
        <div class="col-lg-5 offset-lg-1">
            ...
            <form id="member-registration" action="<?php echo Route::_('index.php?option=com_users&task=registration.register'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
                ...
                <?php endforeach; ?>
                <div class="mt-4">
                    <button type="submit" class="btn btn-primary sppb-btn-rounded validate"><?php echo Text::_('JREGISTER'); ?></button>
                    <a class="btn btn-secondary sppb-btn-rounded mx-4" href="<?php echo Route::_(''); ?>" title="<?php echo Text::_('JCANCEL'); ?>"><?php echo Text::_('JCANCEL'); ?></a>
