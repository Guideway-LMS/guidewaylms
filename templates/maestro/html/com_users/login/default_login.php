...
\JLoader::register('TplMaestroHelper', JPATH_THEMES . '/maestro/helper.php');

$usersConfig = ComponentHelper::getParams('com_users');

$loginDescriptionShow = TplMaestroHelper::checkNull($this->params->get('logindescription_show'));
$loginDescription = TplMaestroHelper::checkNull($this->params->get('login_description'));
...
<div class="login<?php echo $this->pageclass_sfx; ?>">
    <div class="row">
        <div class="col-lg-5 offset-lg-1">
            ...
            <?php if (($loginDescriptionShow == 1 && str_replace(' ', '', $loginDescription) != '') || $this->params->get('login_image') != '') : ?>
                <div class="login-description">
                <?php endif; ?>

                <?php if ($loginDescriptionShow == 1) : ?>
