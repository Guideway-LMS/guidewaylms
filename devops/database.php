                ...
                <div class="action-area" style="flex-direction: column; align-items: flex-start; gap: 15px;">
                    ...
                    <div style="width: 100%;">
                        ...
                        <div class="user-btn-group" id="btn-group-1">
                            ...
                            <button class="user-btn" onclick="selectUser(this, 'erickafonso')">Erick Afonso</button>
                            <button class="user-btn" onclick="selectUser(this, 'vitoriasouza')">Vitória Souza</button>
                        </div>
